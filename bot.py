...
async def main():
    logger.info("⏳ Ожидание перед запуском...")
    ...
    logger.info("✅ Flask запущен в фоновом режиме. Запуск бота...")

    # Запуск бота (в режиме вебхука он будет ждать входящие обновления)
    await app.run_polling()  # Render требует, чтобы процесс не завершался
